...
class _PersonApiinteractMethod extends GeneratedReflectedMethod<PersonApi, IChannel<String, String>> {
...
@override
List get annotations => const [HttpRequestMethod(type: HttpMethodType.webSocket, route: 'interact')];
...
@override
IChannel<String, String> callReservedMethod({required PersonApi? entity, required List fixedValues, required Map<String, dynamic> namedValues}) =>
entity!.interact();
}
...
class _AlbumTest extends GeneratedReflectorAlbum {
  const _AlbumTest();
  @override
  List<GeneratedReflectedClass> get classes => const [_PersonApi(),_Person()];
