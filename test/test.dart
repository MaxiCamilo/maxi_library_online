...
class _PersonfirstName extends GeneratedReflectedField<Person, String> with GeneratedReflectedModifiableField<Person, String> {
  ...
  @override
  String getReservedValue({required Person? entity}) => entity!.firstName;
  @override
  void setReservedValue({required Person? entity, required String newValue}) => entity!.firstName = newValue;
}
...
class _PersonlastName extends GeneratedReflectedField<Person, String> with GeneratedReflectedModifiableField<Person, String> {
  ...
  @override
  String getReservedValue({required Person? entity}) => entity!.lastName;
  @override
  void setReservedValue({required Person? entity, required String newValue}) => entity!.lastName = newValue;
}
...
class _PersonisAdmin extends GeneratedReflectedField<Person, bool> with GeneratedReflectedModifiableField<Person, bool> {
  ...
  @override
  bool getReservedValue({required Person? entity}) => entity!.isAdmin;
  @override
  void setReservedValue({required Person? entity, required bool newValue}) => entity!.isAdmin = newValue;
}
...
class _Personage extends GeneratedReflectedField<Person, int> with GeneratedReflectedModifiableField<Person, int> {
  ...
  @override
  int getReservedValue({required Person? entity}) => entity!.age;
  @override
  void setReservedValue({required Person? entity, required int newValue}) => entity!.age = newValue;
}
...
class _PersonBuilder extends GeneratedReflectedMethod<Person, Person> {
  ...
  @override
  Person callReservedMethod({required Person? entity, required List fixedValues, required Map<String, dynamic> namedValues}) => Person();
}
...
class _PersonApigetAllPersonMethod extends GeneratedReflectedMethod<PersonApi, List<Person>> {
  ...
  @override
  List<Person> callReservedMethod({required PersonApi? entity, required List fixedValues, required Map<String, dynamic> namedValues}) => entity!.getAllPerson();
}
...
class _PersonApigetSpecificPersonMethod extends GeneratedReflectedMethod<PersonApi, Future<Person>> {
  ...
  @override
  Future<Person> callReservedMethod({required PersonApi? entity, required List fixedValues, required Map<String, dynamic> namedValues}) => entity!.getSpecificPerson(
        id: _namid.getValueFromMap(namedValues),
      );
}
...
class _PersonApisayHiMethod extends GeneratedReflectedMethod<PersonApi, String> {
  ...
  @override
  String callReservedMethod({required PersonApi? entity, required List fixedValues, required Map<String, dynamic> namedValues}) => entity!.sayHi();
}
...
class _PersonApigetContentMethod extends GeneratedReflectedMethod<PersonApi, Future<void>> {
  ...
  @override
  Future<void> callReservedMethod({required PersonApi? entity, required List fixedValues, required Map<String, dynamic> namedValues}) => PersonApi.getContent(
        request: _namrequest.getValueFromMap(namedValues),
      );
}
...
class _PersonApistreamNumbersMethod extends GeneratedReflectedMethod<PersonApi, Stream<String>> {
  ...
  @override
  Stream<String> callReservedMethod({required PersonApi? entity, required List fixedValues, required Map<String, dynamic> namedValues}) => entity!.streamNumbers();
}
...
class _PersonApiinteractMethod extends GeneratedReflectedMethod<PersonApi, StreamController<String>> {
  ...
  @override
  StreamController<String> callReservedMethod({required PersonApi? entity, required List fixedValues, required Map<String, dynamic> namedValues}) => entity!.interact();
}
...
class _PersonApibidirectionalMethod extends GeneratedReflectedMethod<PersonApi, BidirectionalStreamFactory> {
  ...
  @override
  BidirectionalStreamFactory callReservedMethod({required PersonApi? entity, required List fixedValues, required Map<String, dynamic> namedValues}) => entity!.bidirectional();
}
...
class _PersonApiBuilder extends GeneratedReflectedMethod<PersonApi, PersonApi> {
  ...
  @override
  PersonApi callReservedMethod({required PersonApi? entity, required List fixedValues, required Map<String, dynamic> namedValues}) => PersonApi();
}
...
class _PersonApi extends GeneratedReflectedClass<PersonApi> {
  ...
  List<GeneratedReflectedMethod> get methods => const [
        _PersonApigetAllPersonMethod(),
        _PersonApigetSpecificPersonMethod(),
        _PersonApisayHiMethod(),
        _PersonApigetContentMethod(),
        _PersonApistreamNumbersMethod(),
        _PersonApiinteractMethod(),
        _PersonApibidirectionalMethod(),
        _PersonApiBuilder()
      ];
